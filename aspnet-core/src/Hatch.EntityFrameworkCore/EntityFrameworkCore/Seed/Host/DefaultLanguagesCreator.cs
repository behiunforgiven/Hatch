...
namespace Hatch.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HatchDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HatchConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HatchDbContext context)
        {
            _context = context;
        }
