...
{
    public abstract class HatchWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HatchWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HatchWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HatchDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HatchDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HatchDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HatchDbContext, Task<T>> func)
        {
            T result;
